            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div class="group relative h-full" style="opacity: 1; transform: none;">
                    <div class="relative h-full p-4 rounded-2xl bg-card border border-border card-hover hover:border-primary/40 overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 gap-y-3 pt-4 border-t border-dashed border-border">
                            <div>
                                <img class="w-100" src="assets/images/pngtree-green-bar-graph-showing-upward-growth-trend-png-image_16258899.png" alt="">
                            </div>
                            <div>
                                <ul class="">
                                    <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                ...
                <div class="group relative h-full" style="opacity: 1; transform: none;">
                    <div class="relative h-full p-4 rounded-2xl bg-card border border-border card-hover hover:border-primary/40 overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 gap-y-3 pt-4 border-t border-dashed border-border">
                            <div>
                                <img class="w-100" src="assets/images/3d-business-case-brown-leather-businessman-briefcase-png.png" alt="">
                            </div>
                            <div>
                                <ul class="">
                                    <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                ...
                <div class="group relative h-full" style="opacity: 1; transform: none;">
                    <div class="relative h-full p-4 rounded-2xl bg-card border border-border card-hover hover:border-primary/40 overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 gap-y-3 pt-4 border-t border-dashed border-border">
                            <div>
                                <img class="w-100" src="assets/images/pngtree-technical-team-icon-teamwork-support-vector-vector-png-image_38010796.png" alt="">
                            </div>
                            <div>
                                <ul class="">
                                    <li class="flex items-start gap-2.5 text-sm text-foreground/85">
