...
<div class="min-h-screen flex flex-col bg-background">
    <div class="mb-5 relative overflow-hidden isolate bg-secondary text-secondary-foreground">
        ...
        <div class="relative z-10">
            <img class="w-100" src="assets/images/mobile-app-development.jpg" alt="">
                    ...
                    <div class="relative h-full p-4 rounded-2xl bg-card border border-border card-hover hover:border-primary/40 overflow-hidden">
                        ...
                        <div class="relative flex items-start gap-4 mb-6">
                            <div class="relative shrink-0">
                                <div class="w-12  h-12 rounded-3 bg-gradient-to-br from-primary/15 to-primary/5 border border-primary/20 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house text-primary">
                                        <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"></path>
                                        <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                    </svg></div>
                            </div>
                            <div>
                                <h2 class="font-display font-semibold text-2xl text-foreground leading-tight">Services portfolio</h2>
                            </div>
                        </div>
                        <ul class="grid grid-cols-1 gap-x-5 gap-y-3 pt-4 border-t border-dashed border-border">
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                ...
                                <span>Enterprise mobility needs assessment</span>
                            </li>
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 text-primary mt-0.5 shrink-0">
                                    <circle cx="12" cy="12" r="10"></circle>
                                ...
                                <span>Enterprise architecture re-engineering for mobility</span>
                            </li>
                            ...
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                ...
                                <span>SR&D and custom technology developmen</span>
                            </li>
                            ...
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                ...
                                <span>Deployment management—web stores and mobile fleet</span>
                            </li>
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 text-primary mt-0.5 shrink-0">
                                    <circle cx="12" cy="12" r="10"></circle>
                                ...
                                <span>Enterprise mobility support services</span>
                            </li>
                        </ul>
                        ...
                        <div class="relative flex items-start gap-4 mb-6">
                            <div class="relative shrink-0">
                                <div class="w-12  h-12 rounded-3 bg-gradient-to-br from-primary/15 to-primary/5 border border-primary/20 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house text-primary">
                                        <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"></path>
                                        <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                    </svg>
                                </div>
                            ...
                            <div>
                                <h2 class="font-display font-semibold text-2xl text-foreground leading-tight">Expertise</h2>
                            </div>
                        </div>
                        <ul class="grid grid-cols-1 gap-x-5 gap-y-8 pt-4 border-t border-dashed border-border">
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                <div class="icon-box">
                                    <svg fill="#ffa200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-phone-flip" viewBox="0 0 16 16">
                                ...
                                <span>Mobile OS- Android, Apple iOS, Windows Phone, Blackberry / QNX</span>
                            </li>
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                <div class="icon-box">
                                    <svg fill="#ffa200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-code-slash" viewBox="0 0 16 16">
                                        <path d="M10.478 1.647a.5.5 0 1 0-.956-.294l-4 13a.5.5 0 0 0 .956.294zM4.854 4.146a.5.5 0 0 1 0 .708L1.707 8l3.147 3.146a.5.5 0 0 1-.708.708l-3.5-3.5a.5.5 0 0 1 0-.708l3.5-3.5a.5.5 0 0 1 .708 0m6.292 0a.5.5 0 0 0 0 .708L14.293 8l-3.147 3.146a.5.5 0 0 0 .708.708l3.5-3.5a.5.5 0 0 0 0-.708l-3.5-3.5a.5.5 0 0 0-.708 0" />
                                    </svg>
                                </div>
                                <span>Development Platforms- PhoneGAP, Appcelerator, Titanium, Eclipse, NetBeans, XCode, J2ME</span>
                            </li>
                            ...
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                ...
                                <div class="icon-box">
                                    <svg fill="#ffa200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-database" viewBox="0 0 16 16">
                                ...
                                <span>Middleware Platforms- J2ME, OpenMax, GStreamer</span>
                            </li>
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">


                                <div class="icon-box">
                                    <svg fill="#ffa200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-cloud-check" viewBox="0 0 16 16">
                                ...
                                <span>Cloud Platform- Amazon, Google, Microsoft, OpenStack</span>
                            </li>
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                <div class="icon-box">
                                    <svg fill="#ffa200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                    </svg>
                                </div>
                                <span> Usability and Graphics- Illustrator, Photoshop, Flash, Fireworks, CorelDraw, InkScape</span>
                            </li>
                            <li class="flex items-start gap-2.5 text-sm text-foreground/85">
                                <div class="icon-box">
                                    <svg fill="#ffa200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-window-stack" viewBox="0 0 16 16">
                                        <path d="M4.5 6a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1M6 6a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1m2-.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0" />
                                        <path d="M12 1a2 2 0 0 1 2 2 2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2 2 2 0 0 1-2-2V3a2 2 0 0 1 2-2zM2 12V5a2 2 0 0 1 2-2h9a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1m1-4v5a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V8zm12-1V5a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v2z" />
                                    </svg>
                                </div>
                                <span>GUI Development- AJAX, HTML5, Web 2.0, DirectFB, QT</span>
                            </li>
                        </ul>
